...
<?php if ( checkRole() === 'admin' ): ?>
    <header>
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <a class="navbar-brand" href="<?php echo get_permalink(get_page_by_path('dashboard')->ID); ?>">Sigma Picture</a>
            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
                <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                    <li class="nav-item active">
                        <a class="nav-link" href="<?php echo get_permalink(get_page_by_path('dashboard')->ID); ?>">Dashboard</a>
                    </li>
                    <li class="nav-item active">
                        <a class="nav-link" href="<?php echo get_permalink(get_page_by_path('find-user')->ID); ?>">Trouver un utilisateur</a>
                    </li>
                    <li class="nav-item">
